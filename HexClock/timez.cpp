...
#include <pgmspace.h>
#define NUM_TZS 461
const char* const timez[NUM_TZS][2] PROGMEM =  {
	...
	{"TZ_America_Bahia_Banderas", "PSTR(\"CST6\")"},
	...
	{"TZ_America_Chihuahua", "PSTR(\"CST6\")"},
	...
	{"TZ_America_Nuuk", "PSTR(\"<-02>2\")"},
	{"TZ_America_Ojinaga", "PSTR(\"CST6CDT,M3.2.0,M11.1.0\")"},
	...
	{"TZ_Asia_Gaza", "PSTR(\"EET-2EEST,M3.4.4/50,M10.4.4/50\")"},
	{"TZ_Asia_Hebron", "PSTR(\"EET-2EEST,M3.4.4/50,M10.4.4/50\")"},
